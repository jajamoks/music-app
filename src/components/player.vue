	...
	<div class="player" v-show="playList.length">
			...
			<div class="normal-player" v-show="fullScreen">
				...
				<div class="bottom">
					...
					<div class="operators">
						...
						<div ref="audio" class="icon i-center" :class="disableCls">
		...
		<transition name="mini">
			<div class="mini-player" v-show="!fullScreen" @click="open">
				<div class="icon">
					<img :class="cdCis" width="40" height="40" :src="currentSong.image">
				</div>
				<div class="text">
...
<script type="text/javascript">
	...
	// const transitionDutarion = prefixStyle('transitionDutarion')
	...
	// 			this.$refs.lyricList.$el.style[transitionDutarion] = 0
	// 			this.$refs.middleL.style.opacity = 1 - this.touch.percent
	// 			this.$refs.middleL.style[transitionDutarion] = 0
	// 		},
	// 		middleTouchEnd(e) {
	// 			if (!this.touch.moved) {
	// 				return
	...
	// 			const time = 300
	// 			this.$refs.lyricList.$el.style[transform] = `translate3d(${offsetWidth}px,0,0)`
	// 			this.$refs.lyricList.$el.style[transitionDutarion] = `${time}ms`
	...
	const transform = prefixStyle('transform')
	const transitionDuration = prefixStyle('transitionDutarion')
